TOPDIR=$(shell pwd)
BUILD_SLN=./jaytwo.Subprocess.sln
BUILD_DIR=./src/jaytwo.Subprocess
BUILD_TEST_DIR=./test/jaytwo.Subprocess.Tests
BUILD_TRX_FILENAME=jaytwo.Subprocess.Tests.trx
